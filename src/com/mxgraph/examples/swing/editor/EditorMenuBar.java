...
import com.mxgraph.examples.swing.editor.EditorActions.GroundedAlgAction;
...
import com.mxgraph.examples.swing.editor.EditorActions.PreferredAlgAction;
...
public class EditorMenuBar extends JMenuBar
{
	...
	public EditorMenuBar(final BasicGraphEditor editor)
	{
		...
		//Ana: creating menu for graph labellings
                menu = add(new JMenu("Labelling"));
                menu.add(editor.bind("Grounded Labelling", new GroundedAlgAction()));
                menu.add(editor.bind("Preferred Labelling", new PreferredAlgAction()));
